...
public class PlayerAttackBehaviour : MonoBehaviour
{
    ...
    private void Start()
    {
        horizontal = Input.GetAxisRaw("HorizontalPlayerOne");
        vertical = Input.GetAxisRaw("VerticalPlayerOne");
    }
    ...
    void FixedUpdate()
    {
        ...
        transform.localPosition = new Vector3(movementVector.normalized.x, movementVector.normalized.y, 0);
